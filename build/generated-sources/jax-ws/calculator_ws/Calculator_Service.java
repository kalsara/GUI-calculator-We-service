 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://calculator_ws/", wsdlLocation = "http://localhost:4054/calculator_ws/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://calculator_ws/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:4054/calculator_ws/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calculator_ws/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator_ws/", "CalculatorPort"), Calculator.class, features);
    }
